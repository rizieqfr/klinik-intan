...
export default function Pendaftaran({accessToken}) {
        ...
        <Modal 
            ...
            content= {
                <div className=' w-full space-y-[12px]'>
                    ...
                    <div>
                        <select onChange={formik.handleChange} className='py-[13px] px-[16px] border rounded w-full bg-slate-200' name="jenisPerawatan" value={formik.values.jenisPerawatan}>
                    ...
                    {formik.values.jenisPerawatan === 'Rawat Jalan' ? (
                    ...
                    ) : formik.values.jenisPerawatan === 'IGD' ? (
                        <div className='grid grid-cols-12 gap-y-8'>
                            <div className='grid space-y-2 col-span-2 items-center'>
                                <h1>Pasien</h1>
                                <h1>Keluhan</h1>
                                <h1>Pengantar Pasien</h1>
                                <h1>Dokter & Poli</h1>
                    ...
                    ) : formik.values.jenisPerawatan === 'Rawat Inap' ? (
                        <div className='grid grid-cols-12 gap-y-8'>
                            <div className='grid space-y-2 col-span-2 items-center'>
                                <h1>Pasien</h1>
                        ...
                        <h1>Pilih Jenis Perawatan Terlebih Dahulu</h1>
                    )}
        ...
        <div className='bg-white flex gap-[32px] min-h-screen'>
                ...
                <div className='w-full pb-10 pr-[32px]'>
                    <div className='flex items-start justify-between  pt-[40px] mb-4'>
                        <h1 className='text-4xl text-[#353A40] font-bold'>Pendaftaran Pasien</h1>
                        <h1>Navigasi / <span className='text-cyan font-medium'>Pendaftaran Pasien</span></h1>
                    </div>
