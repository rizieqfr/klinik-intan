...
export default function PendaftaranUgd({accessToken}) {
        ...
        <div className='bg-white flex gap-[32px] min-h-screen'>
                ...
                <div className='w-full pb-10 pr-[32px]'>
                    <div className='flex items-start justify-between  pt-[40px] mb-4'>
                        <h1 className='text-4xl text-[#353A40] font-bold'>Pendaftaran Pasien UGD</h1>
                        <h1> / Pendaftaran / <span className='text-cyan font-medium'>Pendaftaran Pasien UGD</span></h1>
                    </div>
