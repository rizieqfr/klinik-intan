  ...
  return (
    ...
    <div className='mt-5'>
                    <div className='w-full'>
                        <div className='border rounded-md p-4 w-full mb-10'>
                            <table className='w-full'>
                                <thead>
                                    <tr>
                                        <th className='border-b py-3 text-left'>Nama Obat / Layanan</th>
                                ...
                                <tbody>
                                    ...
                                    {/* Render Obat */}
                                    {dataInvoice?.obat.map((item, index) => (
                                        <tr key={index}>
                                            <td className='border-b py-3'>{item.name}</td>
                                            <td className='border-b py-3'>{item.qty}</td>
                                            {/* <td className='border-b py-3'></td> */}
                                        </tr>
                                    ))}
                                    {/* Render Tindakan */}
                                    {dataInvoice?.tindakan.map((item, index) => (
                                        <tr key={index}>
                                            <td className='border-b py-3'>{item.name}</td>
                                            <td className='border-b py-3'>{item.qty}</td>
                                            {/* <td className='border-b py-3'></td> */}
                                ...
                                <tfoot>
                                    <tr>
                                        <td className='border-t py-3 font-bold'>Jumlah Quantity</td>
                                        {/* <td className='border-t py-3 font-bold'>2</td> */}
                                        <td className='border-t py-3 font-bold'>{dataInvoice?.totalQtyObat + dataInvoice?.totalQtyTindakan}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div className='border rounded-md p-4 w-full'>
                            <table className='w-full'>
                                <thead>
                                    <tr>
                                        <th className='border-b py-3 text-left'>Total Tarif</th>
                                        <th className='border-b py-3 text-left'>Harga</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td className='py-3 text-end' colSpan='3'>
                                            Status: <span className='text-red-500 font-bold'>{dataInvoice?.status}</span>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
