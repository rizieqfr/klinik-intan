...
export default function PembayaranRawatJalan({accessToken}) {
    ...
    const getDataPayment = async () => {
        try {
            const res = await ClientRequest.GetPayment(accessToken, 'rawat-jalan')
        ...
        <div className='bg-white flex gap-[32px] min-h-screen'>
            ...
            <div className='w-full pr-[32px]'>
                <div className='flex items-center justify-between pt-[40px] mb-8'>
                    <h1 className='text-4xl text-[#353A40] font-bold'>Pembayaran Rawat Jalan</h1>
                    <h1>Navigasi / <span className='text-cyan font-medium'>Pembayaran Rawat Jalan</span></h1>
                </div>
